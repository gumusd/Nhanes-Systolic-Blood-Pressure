...
```{r}
nhanes_systolic <- read_excel("D:/EDUCATION/SEMESTERS/6th_Semester/STAT364/Term Project/datasets/nhanes_systolic.xlsx")
...
Try for all variables in best model. (Recit10/26)
...
Did we specify the functional relationships correctly??????? recit 10 syf 72.
